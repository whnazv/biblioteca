package onion.whnazv.biblioteca.domain.exception;
...
public class GlobalExceptionHandler {
    ...
    public ModelAndView handleWebExceptions(Exception ex, HttpServletRequest request) {
